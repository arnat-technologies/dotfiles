...
DEVCONTAINER_TIMEZONE -> $DEVCONTAINER_TIMEZONE
...
unset DEVCONTAINER_RAM_FOLDER \
DEVCONTAINER_DOTFILES \
DEVCONTAINER_TARGET \
DEVCONTAINER_SHELL \
DEVCONTAINER_DOCKERFILE \
DEVCONTAINER_DOCKERCOMPOSEFILE \
DEVCONTAINER_EXTENSIONS \
DEVCONTAINER_WORKSPACE \
DEVCONTAINER_NODE_VERSION \
DEVCONTAINER_YARN_VERSION \
DEVCONTAINER_NPM_VERSION \
DEVCONTAINER_TIMEZONE
