...
[ ! -z "$DEVCONTAINER_DOTFILES" ] || DEVCONTAINER_DOTFILES="rsurjano/dotfiles"
...
unset DEVCONTAINER_RAM_FOLDER DEVCONTAINER_DOTFILES DEVCONTAINER_TARGET DEVCONTAINER_SHELL DEVCONTAINER_DOCKERFILE GENERATOR_FOLDER
